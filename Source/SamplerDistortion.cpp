...
SamplerDistortion::SamplerDistortion(MUS_12_SamplerAudioProcessor& p) : audioProcessor(p)
{
    ...
    gainS.setTextBoxStyle(juce::Slider::TextBoxRight, true, 50, 20);
    ...
    driveS.setTextBoxStyle(juce::Slider::TextBoxRight, true, 50, 20);
    ...
    rangeS.setTextBoxStyle(juce::Slider::TextBoxRight, true, 50, 20);
    ...
    blendS.setTextBoxStyle(juce::Slider::TextBoxRight, true, 50, 20);
